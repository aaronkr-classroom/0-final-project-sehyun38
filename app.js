...
const pagesController = require("./controllers/pagesController"),
  ...
  gameSubscribersController = require("./controllers/gameSubscribersController")
;
...
router.get(
  "/gameSubscribers",
  gameSubscribersController.index,
  gameSubscribersController.indexView
); // index 라우트 생성
router.get("/gameSubscribers/new", gameSubscribersController.new); // 생성 폼을 보기 위한 요청 처리
router.post(
  "/gameSubscribers/create",
  gameSubscribersController.create,
  gameSubscribersController.redirectView
); // 생성 폼에서 받아온 데이터의 처리와 결과를 사용자 보기 페이지에 보여주기
router.get(
  "/gameSubscribers/:id",
  gameSubscribersController.show,
  gameSubscribersController.showView
);
router.get("/gameSubscribers/:id/edit", gameSubscribersController.edit); // viewing을 처리하기 위한 라우트 추가
router.put(
  "/gameSubscribers/:id/update",
  gameSubscribersController.update,
  gameSubscribersController.redirectView
); // 편집 폼에서 받아온 데이터의 처리와 결과를 사용자 보기 페이지에 보여주기
router.delete(
  "/gameSubscribers/:id/delete",
  gameSubscribersController.delete,
  gameSubscribersController.redirectView
);
 ...
 * Games
 */
router.get("/games", gameController.index, gameController.indexView); // index 라우트 생성
router.get("/games/new", gameController.new); // 생성 폼을 보기 위한 요청 처리
router.post(
  "/games/create",
  gameController.create,
  gameController.redirectView
); // 생성 폼에서 받아온 데이터의 처리와 결과를 사용자 보기 페이지에 보여주기
router.get("/games/:id", gameController.show, gameController.showView);
router.get("/games/:id/edit", gameController.edit); // viewing을 처리하기 위한 라우트 추가
router.put(
  "/games/:id/update",
